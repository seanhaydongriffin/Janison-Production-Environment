...
Local $subscription_arr[5]
$subscription_arr[0] = "ECSA"
$subscription_arr[1] = "EA"
$subscription_arr[2] = "UOL"
$subscription_arr[3] = "RMS"
$subscription_arr[4] = "Insights"
...
for $subscription_num = 0 to (UBound($subscription_arr) - 1)
	...
	$ps_script_arr[1] = "Get-AzureRmResource -ResourceType 'Microsoft.Sql/servers' -ResourceGroupName '*-PROD*'"
